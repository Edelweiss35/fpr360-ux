...
@Component({
  selector: 'app-partner-merchant',
  templateUrl: './partner-merchant.component.html',
  styleUrls: ['./partner-merchant.component.scss']
})
export class PartnerMerchantComponent implements OnInit {
  clientsList = [
    {
      name: 'Orca Nutra Inc.',
      included: true,
