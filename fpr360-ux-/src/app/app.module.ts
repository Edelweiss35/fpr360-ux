...
import { CompanyListService } from '../app/data.service';
import { OnboardingPartnerModule} from '../app/pages/partners/onboarding-partner/onboarding-partner.module';
...
import { PartnerMerchantComponent } from './pages/partners/partner/partner-merchant/partner-merchant.component';
...
import { OnboardingPartnerComponent } from './onboarding-partner.component';-debugger
// Routes
...
const innerPartner: Routes = [
  ...
  { path: 'merchant', component: PartnerMerchantComponent }
];
